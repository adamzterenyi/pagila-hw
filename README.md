# pagila-hw
[![](https://github.com/adamzterenyi/pagila-hw/workflows/tests/badge.svg)](https://github.com/adamzterenyi/pagila-hw/actions?query=workflow%3Atests)
...
1. Fork this repo + clone it on the lambda server.
